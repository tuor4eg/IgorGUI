    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <TouchableOpacity style={this.getPressedButton(menu.button1)} onPress={() => this.props.onPressMenu(menu.button1)}>
                ...
                <TouchableOpacity style={this.getPressedButton(menu.button2)}  onPress={() => this.props.onPressMenu(menu.button2)}>
                    <View style={styles.inner}>
                    <Image 
                    source={pic2}/>
                ...
                <TouchableOpacity style={this.getPressedButton(menu.button3)}  onPress={() => this.props.onPressMenu(menu.button3)}>
                    <View style={styles.inner}>
                    <Image 
                    source={pic3}/>
                ...
                <TouchableOpacity style={this.getPressedButton(menu.button4)}  onPress={() => this.props.onPressMenu(menu.button4)}>
                    <View style={styles.inner}>
                    <Image 
                    source={pic4}/>

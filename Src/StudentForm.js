...
import {Button, Image, Text, View, Alert, TextInput, TouchableHighlight, FlatList, Picker } from 'react-native';
...
export default class StudentForm extends Component {
    ...
    renderPicker = () => {
        return(
            this.props.groupList.map(item => <Picker.Item 
    ...
    checkAction = () => this.props.tmp.id === 'new' ? () => this.props.addStudent(this.props.tmp.groupId) : () => this.props.editStudent(this.props.tmp.id);
